...
class W4PL_Helper_Users extends W4PL_Core
{
	...
	public function admin_list_fields( $fields, $options )
	{
		...
		$fields['before_field_group_users_query'] = array(
			'position'		=> '5',
			'html' 			=> '<div id="w4pl_field_group_users_query" class="w4pl_field_group"><div class="w4pl_group_title">Users</div><div class="w4pl_group_fields">'
		);
		...
		$fields['after_field_group_users_query'] = array(
			'position'		=> '50',
			'html' 			=> '</div><!--.w4pl_group_fields--></div><!--#w4pl_field_group_users_query-->'
		);
